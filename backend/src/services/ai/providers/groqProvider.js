...
function createGroqProvider(opts = {}) {
  const apiKey = opts.apiKey || process.env.GROQ_API_KEY || process.env.AI_API_KEY;
  const model = opts.model || process.env.GROQ_MODEL || process.env.AI_MODEL || 'openai/gpt-oss-20b';
