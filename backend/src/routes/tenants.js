...
// GET /api/tenants — list all tenants (secrets masked)
router.get('/', (req, res) => {
...
// PATCH /api/tenants/:id — update tenant fields (any subset)
...
// POST /api/tenants/:id/activate — set this tenant as the one the agent uses
