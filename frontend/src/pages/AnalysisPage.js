...
export default function AnalysisPage() {
  const [mode, setMode] = useState('investigate'); // 'investigate' | 'manual'
    ...
    <div>
      ...
      <div className="page-header flex items-center justify-between">
        <div>
          ...
          <p>
            {mode === 'investigate'
              ? 'Select an incident to run automated evidence collection and AI root cause analysis'
              : 'Ad-hoc analysis for testing — not tied to a real incident'}
          </p>
        </div>
        ...
        >
            ...
            <div className="card">
              <div className="card-header">
                <span className="card-title">
                  <BookOpen size={15} /> Scenario Library
                </span>
              </div>
              ...
              >
                Click to pre-fill the analysis form
              </p>
          ...
          >
            ...
            <div className="card">
              <div className="card-header">
                <span className="card-title">
                  <Search size={15} /> Analyze Incident
                </span>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    className="input"
                    placeholder="e.g. SF_Order_Sync_v2"
                    value={form.iflow}
                    onChange={e =>
                      setForm(f => ({
                        ...f,
                        iflow: e.target.value
                      }))
                    }
                  />
                </div>
              ...
              >
                ...
                >
                  <input
                    ...
                    checked={autoTicket}
                    onChange={e =>
                      setAutoTicket(e.target.checked)
                    }
                    style={{
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <div
                      style={{
                        ...
                        fontWeight: 700,
                        color:
                          ticketResult.ticket?.priority === 'CRITICAL'
                            ? 'var(--critical)'
                            : ticketResult.ticket?.priority === 'HIGH'
                              ? 'var(--high)'
                              : 'var(--medium)'
                      }}
                    >
                  ...
                  <div>
                    ...
                    >
                      {ticketResult.ticket?.assignedTeam}
                    </div>
                  </div>
                </div>
              </div>
